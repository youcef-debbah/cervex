 ...
 */
public class EnterpriseAddressValidator implements ConstraintValidator<EnterpriseAddress, String> {

    @Override
    public void initialize(EnterpriseAddress constraintAnnotation) {
	// do nothing
    }
